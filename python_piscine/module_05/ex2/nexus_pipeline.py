...
class NexusManager:
    ...
    def process(self, data: Any):
        ...
        for pipe, data in zip(self.pipelines, data):
            pipe.process(data)
...
def ft_main():
    ...
    pipe_batch = [
        ...
        JSONAdapter("json_003"),
        JSONAdapter("json_004"),
        JSONAdapter("json_005"),
        JSONAdapter("json_006"),
        CSVAdapter("csv_002"),
        CSVAdapter("csv_003"),
        CSVAdapter("csv_004"),
        CSVAdapter("csv_005"),
        ...
        StreamAdapter("str_003"),
        StreamAdapter("str_004"),
        StreamAdapter("str_005"),
        StreamAdapter("str_006"),
    ]
